...
flat1 = Listing.create!(location: "london", name: "Spacious flat in central London", description: "Cozy, sunlit one-bedroom nestled on the third floor of a quiet building. Large windows flood the living room with natural light, highlighting the warm wooden floors and minimalist decor.", price: 100, number_guests: 2, user: user1, image_url:"https://blog.studios2let.com/wp-content/uploads/2021/04/fully-furnished-studio-flat-Penywern-earls-court.jpg", address: "1 Grosvenor Pl London SW1X 7HJ United Kingdom")
...
flat2 = Listing.create!(location: "Rome", name: "Modern flat", description: "1-bedroom flat in Rome. Lovely bedroom offers a peaceful retreat with soft lighting and ample closet space.", price: 90, number_guests: 2, user: user2, image_url: "https://www.burghesius.com/wp-content/uploads/2023/03/2.-A-different-kind-of-luxury--scaled.jpg", address: "Via del Babuino 9 00187 Rome, Italy")
