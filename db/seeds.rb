...
house3 = Listing.create!(location: "Paris", name: "Warm tones and welcoming space", description: "Make yourself at home in this beautifully furnished, spacious house perfect for families, couples, or business travelers. The home features 3 comfortable bedrooms and a cozing living room", price: 140, number_guests: 4, user: user2, image_url: "https://www.parisperfect.com/blog/wp-content/uploads/2023/03/temp-paris-perfect-beaux-reves-1.jpg", address: "Champ de Mars, 5 Av. Anatole France, 75007 Paris, France")
house4 = Listing.create!(location: "Frankfurt", name: "Cozy retreat in quiet neighborhood", description: "Centrally located in a quiet, safe neighborhood, you’ll be just minutes from local cafes, shops, parks, and public transit.", price: 140, number_guests: 4, user: user2, image_url: "https://wunderflatsng.blob.core.windows.net/imagesproduction/LKVW2VvPd75zWxCWGxW_l-original", address: "Hamburger Allee 2, 60486 Frankfurt am Main, Germany")
